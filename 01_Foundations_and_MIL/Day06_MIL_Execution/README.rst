...
- **Interfaces**: ARINC 429, ARINC 664, AFDX
- Full details: `aerospace/ <aerospace>`_

🩺 Medical
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
- **Standards**: IEC 62304, ISO 14971, IEC 60601, ISO 26262, DO-178C, ARP4754A, ASPICE
- **Interfaces**: Device buses, Sensor links, Alarm/event channels
- **Representative fault**: sensor spike/dropout or actuator command rejection → therapy halts safely, and alarms notify the operator
