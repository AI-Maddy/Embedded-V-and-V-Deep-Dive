...
Track: **execution-path confidence, WCET evidence, breakpoint determinism**.
...
🟢 Nominal: No issues found
🟡 Boundary: Issue found, but within expected limits
🔴 Fault: Critical issue found
