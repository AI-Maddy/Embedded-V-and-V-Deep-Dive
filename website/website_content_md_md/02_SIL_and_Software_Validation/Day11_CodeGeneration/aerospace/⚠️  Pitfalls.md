...
-   🕳️ **Non-finite support** --- The default `SupportNonFinite = 'on'`
    ...
    --- disable this and ensure the model itself is NaN-free.
-   🕳️ **Licensing during CI** --- Embedded Coder requires a license for
    each generation run. CI pipelines running parallel jobs can exhaust
    the license pool, causing silent generation failures.
:::
