...
💡 These are the **key metrics** that distinguish closed-loop
verification from open-loop. Every closed-loop run must report these.
:::

  -------------------------------------------------------------------------
  \#   Metric            What It Tells You            Pass Criteria
                                                      (typical)
  ---- ----------------- ---------------------------- ---------------------
