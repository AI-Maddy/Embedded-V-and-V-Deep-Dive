...
The mini-project uses 12 requirements derived from a simplified
pitch-axis autopilot specification. Each requirement has a hazard
linkage and DAL.

  -----------------------------------------------------------------------------------------
  Req ID           Description                     Hazard Linkage    DAL     Category
  ---------------- ------------------------------- ----------------- ------- --------------
