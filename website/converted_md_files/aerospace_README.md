...
-   ARP4761: Guidelines and Methods for Conducting the Safety Assessment
  ...
  -----------------------------------------------------------------------
  Compliance        Description                Relevance
  Standard                                     
  ----------------- -------------------------- --------------------------
...
::: admonition
Compliance Mnemonic **HIL-SAFE** - **H**ardware integrity -
**I**nterface confidence - **L**ogic validation - **S**afety assurance -
**A**ccuracy in testing - **F**ault tolerance - **E**vidence
traceability
:::

This mnemonic serves as a reminder of the critical elements needed for
successful verification and validation in the aerospace domain.
