...
objective to ensure comprehensive coverage.

## Review Heuristic 🔍

If a claim cannot be tied to an artifact, mark confidence as
**provisional** and prioritize further investigation.

## Checklist Extension 🛠️

☐ Capture residual risk for unresolved items ☐ Assign ownership for
follow-up actions ☐ Define next steps for resolution

## Traceability Matrix 📊

  -------------------------------------------------------------------------
  **Requirement   **Linked Test Case**         **Evidence Artifact**
  ID**                                         
  --------------- ---------------------------- ----------------------------
  REQ-001         TC-001: Nominal flight mode  Log_001.csv, Graph_001.png
                  stability                    

  REQ-002         TC-002: Boundary mode        Log_002.csv, Graph_002.png
                  transition                   

  REQ-003         TC-003: Fault detection and  Log_003.csv,
                  recovery                     Fault_Report_003.pdf
  -------------------------------------------------------------------------
