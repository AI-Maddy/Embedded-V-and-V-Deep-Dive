...
Provide domain-tailored use cases with evidence expectations aligned to
**ISO 26262 (ASIL) + ISO 21434** 📚.
...
This scenario represents the normal operating conditions of the system.
:::
...
Ensure that the system is functioning as expected in nominal conditions.
:::
...
This scenario represents the boundary conditions of the system.
:::
...
Ensure that the system is functioning as expected near the limits of its
...
::: admonition
This scenario represents a fault condition in the system.
:::
...
Ensure that the system is functioning as expected in fault conditions.
:::
...
This scenario represents the degraded mode of the system.
:::
...
Ensure that the system is functioning as expected in degraded mode.
:::

-   **GIVEN**: reduced system functionality due to hardware failure
-   **WHEN**: adaptive cruise control is engaged
-   **THEN**: degraded-mode operation is maintained within safety
    constraints
...
This pattern ensures that raw captures are preserved alongside
interpreted findings.
:::

-   Preserve raw captures alongside interpreted findings
-   Use a consistent naming convention for raw captures and interpreted
    findings
...
This anti-pattern represents making broad "pass" claims without
...
::: admonition
This anti-pattern represents missing boundary and fault test depth for
high-risk functions.
:::

-   Ensure that boundary and fault test depth is sufficient for
    high-risk functions
...
This anti-pattern represents compliance references without concrete
verification links.
:::

-   Provide concrete verification links for compliance references
-   Use a consistent naming convention for compliance references and
    verification links
...
This pitfall represents underestimating interface timing effects.
:::
...
::: admonition
This pitfall represents incomplete alarm and fallback path verification.
:::
...
This pitfall represents weak ownership for unresolved risks.
:::
...
This best practice ensures that scenario definitions are deterministic
and reproducible.
:::
...
This best practice ensures that quantitative pass/fail thresholds are
...
::: admonition
This best practice ensures that residual risk is reviewed before making
...
Severity/Priority Colour Legend: 🟢 Nominal 🟡 Boundary 🔴 Fault
