---
title: "Automation Smoke Test  Canary 2"
...
Before running the full campaign, execute a single known-good scenario
as a sanity gate:
...
After the campaign, re-run a random 10 % sample and compare logs
bit-for-bit:
