Medical Use Cases and Examples
==============================
...
------------------------
- Example A (Nominal): therapy control with validated sensor feedback.
- Example B (Boundary): near-threshold dosing and alarm escalation timing.
- Example C (Fault): sensor spike/dropout and actuator command rejection path.
